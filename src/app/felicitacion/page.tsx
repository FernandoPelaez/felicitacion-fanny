...
export default function FelicitacionPage() {
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-background via-background-light to-background-soft">
      <section className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-3 py-4 sm:px-6 sm:py-7 lg:px-8">
        ...
        <div className="relative z-10 mx-auto flex min-w-0 w-full max-w-6xl flex-1 py-3 sm:py-6">
          <BirthdayDashboard />
        </div>
      </section>
    </main>
